...
// Define precedence2 function here, or include its header
...
PYBIND11_MODULE(reverseNotation, m) {
    ...
    m.def("rpnToInfix", &rpnToInfix, "A function that do reverse Notation");
    ...
    m.def("rpnToInfix2", &rpnToInfix2, "A function that do reverse Notation");

    m.def("addSpacesToInfix", &addSpacesToInfix, "A function that do reverse Notation");
    m.def("removeSpacesFromExpression", &removeSpacesFromExpression, "A function that do reverse Notation");

    m.def("infixToRPN", &infixToRPN, "infixToRPN considering a string not an influx");
}
